...
tiptoe(
    ...
    function compareVersions(setsHTML, previousSetsJSON)
    {
        ...
        var additions = Array.from(domino.createWindow(setsHTML[0]).document.querySelector("h1").nextElementSibling.querySelectorAll("tr td:nth-child(1) a")).map(function(o) { return o.textContent.trim(); }).filter(Boolean);
