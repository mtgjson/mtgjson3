...
tiptoe(
	...
	function render(setRaw)
	{
		...
		set.cards.forEach(function(card)
		{
			...
			["name", "manaCost", "cmc", "type", "supertypes", "types", "subtypes", "rarity", "artist", "number", "loyalty", "power", "toughness", "text", "flavor", "imageName", "rulings"].forEach(function(key) { delete dup[key]; });
